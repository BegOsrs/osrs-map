...
export class RunelitePolyAreaConverter extends OSBotPolyAreaConverter {
    ...
    /*
    API Doc:
        https://static.runelite.net/api/runelite-api/net/runelite/api/coords/package-summary.html
    */
